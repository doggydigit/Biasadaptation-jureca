...
then
    srun python3 deepopt.py --nhidden1 $nh1 --nhidden2 $nh2 --algo1 pmdd --algo2 rp --algoc na --ntask $ntask --tasktype $tasktype --readout $ro --path /users/wybo/Data/results/biasopt/ --datasetpath /work/users/wybo/Data/
fi
