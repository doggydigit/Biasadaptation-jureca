...
#            ]
ALGO_12C = [
            # ["scd", "scd", "ha"], ["pmdd", "rp", "na"],
            # ["pmdd", "pmd", "lstsq"], ["pmdd", "rp", "na"],
            # ["pmdd", "pmdd", "ha"], ["pmdd", "rp", "na"],
            # ["pmdd", "scdfs", "ha"], ["pmdd", "rp", "na"],
            # ["pmdd", "bpo", "na"], ["pmdd", "rp", "na"],
            ["pmddsym", "pmddsym", "ha"], ["pmddsym", "rpsym", "na"],
            ["pmddsym", "scdfssym", "ha"], ["pmddsym", "rpsym", "na"],
            # ["rp", "rp", "na"], ["pmdd", "rp", "na"],
            # ["pmdd", "pmdd", "ha"], ["pmdd", "rp", "na"],
            # ["scd", "scd", "ha"], ["scd", "sc", "lstsq"],
           ]
...
pl.figure('Perf %s ro=%s'%(TASKTYPE, READOUT), figsize=(14,12))
gs = GridSpec(5, 3)
...
for ii in range(int(len(ALGO_12C)/2)):
