...
def bind_job(ns, ds, ls, gls, p0):
    dirdict = {"scan_train_g_xw": "scan_train_xlr_wlr", "scan_train_b_w": "scan_train_blr_wlr",
               "scan_train_g_bw": "scan_train_glr_bwlr", "scan_train_g_bxw": "scan_train_glr_bxwlr",
               "scan_train_bmr": "scan_train_bmr_lr"}
    lr1dict = {"scan_train_g_xw": "wlr", "scan_train_b_w": "wlr", "scan_train_g_bw": "wlr", "scan_train_g_bxw": "wlr",
               "scan_train_bmr": "lr"}
    lr2dict = {"scan_train_g_xw": "glr", "scan_train_b_w": "blr", "scan_train_g_bw": "glr", "scan_train_g_bxw": "glr",
               "scan_train_bmr": "rlr"}
    lr1 = lr1dict[p0]
    lr2 = lr2dict[p0]
...
if __name__ == '__main__':
    ...
    ls = {"EMNIST_bymerge": ["0.0006", "0.0003", "0.0001", "0.00006", "0.00003", "0.00002"],
          "K49": ["0.0006", "0.0003", "0.0001", "0.00006", "0.00003", "0.00002"],
          "CIFAR100": ["0.0006", "0.0003", "0.0001", "0.00006", "0.00003", "0.00002"]}
    gls = {"EMNIST_bymerge": ["0.6", "0.3", "0.1", "0.06", "0.03", "0.02"],
           "K49": ["0.6", "0.3", "0.1", "0.06", "0.03", "0.02"],
           "CIFAR100": ["0.6", "0.3", "0.1", "0.06", "0.03", "0.02"]}
    p0 = "scan_train_g_bw"
    bind_job(ns, ds, ls, gls, p0)
