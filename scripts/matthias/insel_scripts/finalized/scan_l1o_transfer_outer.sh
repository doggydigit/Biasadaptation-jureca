...
ps=( "transfer_b_l1o_lr" "transfer_mr_l1o_lr" "transfer_bmr_l1o_lr")
ls=( "0.5" "0.4" "0.3" "0.2" "0.1" "0.06" "0.03" "0.02" "0.01" "0.006" "0.003" "0.002" "0.001" "0.0006" "0.0003" "0.0001" "0.00003")
for n in ${ns[@]}
do
    for d in "${!ds[@]}"
    do
